...
usually called true and false, and with a set of operators, such as and,
or, and not. It was invented by George Boole, after which it was named, 
to capture the essence of logical human reasoning. 

Boolean algebra should already be familiar to you, though maybe not as 
"an algebra", from your study of the syntax and evaluation of Boolean 
...
- Booleans operators
- functional programs
- propositions, proofs, and proof strategies:
...
an inductive definition of the set of (two) Boolean values as a type
and of a collection operators over this set. That, again, is what we
call an algebra.
-/
